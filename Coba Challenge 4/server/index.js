...
// const people = require("../data/cars.json");
...
function onRequest(req, res) {
  if (req.url === "/") {
    ...
    req.url.includes("tanggal") ||
    req.url.includes("waktu") ||
    req.url.includes("penumpang")
  ) {
    const html = getHTML("cars.html"); // get html file
    res.writeHead(200, { "Content-Type": "text/html" });
    res.end(html);
  } else if (
    req.url.match(".css$") ||
    req.url.match(".js$") ||
    req.url.match("font-awesome.min.css$")
  ) {
