...
class Store {
  ...
  static displayCars() {
    ...
    cars.forEach(function (user) {
      if (
        `${user.tanggal}.${user.waktu}` >= cars.availableAt &&
        `${user.waktu}` >= cars.availableAt
      ) {
        const list = document.getElementById("user-list");
...
document.getElementById("input-form").addEventListener("submit", function (e) {
  const firstName = document.getElementById("driver").value,
    lastName = document.getElementById("tanggal").value,
    email = document.getElementById("waktu").value,
    password = document.getElementById("penumpang").value;
